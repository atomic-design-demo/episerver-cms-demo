...
namespace AtomicDesignDemo.Extensions
{
    ...
    {
        private static readonly Dictionary<string, HandlebarsTemplate<object, object>> _templates = new Dictionary<string, HandlebarsTemplate<object, object>>();

        public static MvcHtmlString RenderTemplate(
            ...
            object context)
        {
            if (!_templates.ContainsKey(templateName))
            {
                ...
                var patternFile = hostingEnvironment
                    .MapPath($"~/assets/patterns/{templateName}.hbs");
